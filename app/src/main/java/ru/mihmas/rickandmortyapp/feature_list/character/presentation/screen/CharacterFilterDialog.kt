        ...
        return AlertDialog.Builder(requireContext())
            ...
            .setPositiveButton("Apply filters") { _, _ ->
                ...
                parentFragmentManager.setFragmentResult(
                    CharacterRemoteListFragment.CHARACTER_DIALOG_BUNDLE,
                    bundleOf(
                        CharacterRemoteListFragment.FILTER_SPECIES to species,
                        CharacterRemoteListFragment.FILTER_TYPE to type,
                        CharacterRemoteListFragment.FILTER_STATUS to status,
                        CharacterRemoteListFragment.FILTER_GENDER to gender
                    )
                )
            }
